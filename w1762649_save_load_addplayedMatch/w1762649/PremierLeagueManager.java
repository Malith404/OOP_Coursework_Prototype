...
public class PremierLeagueManager implements LeagueManager {
  ...
  //Method that is used to display the statistics for a selected club
    ...
    @Override
    public void addPlayedMatch(String homeTeamPlaying, String opponentTeamPlaying, DateMatchPlaying dateMatchPlaying,int goalsScoredHomeTeam, int goalsScoredOpponentTeam) {
