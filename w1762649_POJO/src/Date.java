public class Date {
    ...
    //getter method to get and displaying the day of match playing
    public int getDay() {
        return day;
    }
    ...
    //getter method to get and displaying the month of match playing
    public int getMonth() {
        return month;
    }
    ...
    //getter method to get and displaying the year of match playing
    public int getYear() {
        return year;
    }
