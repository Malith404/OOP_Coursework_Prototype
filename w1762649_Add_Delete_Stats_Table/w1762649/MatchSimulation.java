public class MatchSimulation {
    ...
    public MatchSimulation(String homeTeam, String opponentTeam, Date dateOfMatchPlaying, int goalsScoredHomeTeam, int goalsScoredOpponentTeam) {
    ...
    public String toString() {
        return "MatchSimulation{" +"homeTeam=" + this.homeTeam +", opponentTeam=" + this.opponentTeam  + ", dateOfMatchPlaying=" + this.dateOfMatchPlaying +",                            goalsScoredHomeTeam=" + this.goalsScoredHomeTeam + ", goalsScoredOpponentTeam=" + this.goalsScoredOpponentTeam +'}';
    }
 }
