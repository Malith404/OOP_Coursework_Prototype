 public class FootballClub extends SportsClub implements Comparable<FootballClub> {
    ...
    public FootballClub(String clubName, String country, String location, int noOfMatchesPlayed,int matchesWon, int matchesLost, int matchesDrawn, int goalsScored,
    ...
    public String toString() {
        return super.toString()+", goalsScored=" + this.goalsScored +", goalsReceived=" + this.goalsReceived +", pointsScored=" + this.pointsScored+", " ;
    }
