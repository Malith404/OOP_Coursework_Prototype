public class SchoolFootballClub extends FootballClub{
    ...
    public SchoolFootballClub( String schoolName, int noOfPlayers,String clubName,String country, String location,int noOfMatchesPlayed, int matchesWon, 
				int matchesLost,int matchesDrawn, int goalsScored, int goalsReceived, int pointsScored) {
    ...
    @Override
    public String toString() {  return super.toString() +"schoolName=" + this.schoolName +", noOfPlayers=" + this.noOfPlayers +"}";
    }
 }
