public abstract class SportsClub{
    ...
    public String toString() {
        return "SportsClub{" +"clubName=" + this.clubName + ", country=" + this.country + ", location=" + this.location +", noOfMatchesPlayed=" + 			this.noOfMatchesPlayed + ", matchesWon=" + this.matchesWon +", matchesLost=" + this.matchesLost +", matchesDrawn=" + this.matchesDrawn ;
    }
}
