...
public class TestPremierLeague {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //TEST DATE CLASS
        DateMatchesPlayed dateMatchesPlayed = new DateMatchesPlayed(7, 2, 2020);//date constructor


        //PRINT THE RELEVANT OBJECTS TO TEST
        System.out.println(dateMatchesPlayed);
        System.out.println("\n");
...
*/
        ...
        System.out.println("ADD A PLAYED MATCH :");
         premierLeagueManager.addPlayedMatch("clubGateWay","clubVidura",new DateMatchesPlayed(2,4,2020),4,2);
        System.out.println("\n");
        premierLeagueManager.addPlayedMatch("Chelsea","Manchester United",new DateMatchesPlayed(5,7,2020),2,5);
