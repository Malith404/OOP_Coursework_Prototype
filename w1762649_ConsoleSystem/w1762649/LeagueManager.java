...
public interface LeagueManager {
    ...
    void addPlayedMatch(String homeTeamPlaying, String opponentTeamPlaying, DateMatchesPlayed dateMatchesPlayedMatchPlaying, int goalsScoredHomeTeam, int goalsScoredOpponentTeam);
    void saveInAFile() ;
