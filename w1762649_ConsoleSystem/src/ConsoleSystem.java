...
public class ConsoleSystem extends Application implements Serializable {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (footballClubChoice == 1) {//user chosen university as the division
                    ...
                    premierLeagueManager.displayPremierLeagueTableGUI();//call the GUI table
                    ...
                    premierLeagueManager.displayPremierLeagueTableGUI();//display the premier league table
    ...
    private static void addPlayedMatch() {
        ...
        while (true) {
            ...
            int year = 2020;//year of the match played to set to the match simulation constructor
            System.out.println("\n");
